namespace BlaisePascal.LessonsExamples.Domain.UnitTests
{
    public class EnemyTest
    {
        ...
        [Fact]
        public void TakeDamage_WhenDamageIsNegativeAnArgumentExceptionIsThrown()
        {
            //Arrange
            Enemy newEnemy = new Enemy("Goblin", 80);
            int damage = -20;
        ...
        public void Heal_WhenHealIsBiggerThanMaxHealth_TheHealthIsPutAtMax()
        {
